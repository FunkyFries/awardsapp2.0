...
import Crayons from "../styles/images/Crayons.png";
import Logo from "../styles/images/FullLogo.png";

const KinderCertificate = ({ students }) => {
          ...
          <ThreeRContainer>
            <OutstandingOuterBorder>
              <OutstandingInnerBorder>
                ...
                <PromotionH1>KINDERGARTEN GRADUATION</PromotionH1>
                ...
                <OutstandingH5 style={{ fontSize: "1.3rem" }}>
                  ...
                  <br />
                  Kindergarten at Cascade Christian Schools
                  <br />
            ...
            <CrayonsBackground src={Crayons} alt="Crayons Background" />
          </ThreeRContainer>
        </CertDiv>
      </div>
    );
...
export default KinderCertificate;
